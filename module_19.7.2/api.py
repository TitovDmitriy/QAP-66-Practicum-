...
class PetFriends:
    ...
    def add_new_pet_without_photo(self, auth_key: json, name: str, animal_type: str,
                                  age: str) -> json:
        """"Метод добавляет данные о новом питомце без фото на сервере и возвращает статус
        запроса и результат на сервер в формате JSON"""
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод добавляет данные о новом питомце на сервере и возвращает статус
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """"Метод отправляет фото питомца, по указанному ID, и возвращает статус запроса и
    ...
    def delete_pet(self, auth_key: json, pet_id: str) -> json:
        """Метод отправляет запрос на сервер на удаление данных о питомце по ID и возвращает статус запроса и
        результат в формате JSON"""
        headers = {'auth_key': auth_key['key']}
